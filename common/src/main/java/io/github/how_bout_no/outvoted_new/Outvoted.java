...
import io.github.how_bout_no.outvoted_new.config.OutvotedConfig;
import io.github.how_bout_no.outvoted_new.config.OutvotedConfigClient;
import io.github.how_bout_no.outvoted_new.config.OutvotedConfigCommon;
import io.github.how_bout_no.outvoted_new.entity.*;
import io.github.how_bout_no.outvoted_new.init.*;
//import io.github.how_bout_no.outvoted_new.util.EventRegister;
//import io.github.how_bout_no.outvoted_new.util.compat.PatchouliCompat;
import io.github.how_bout_no.outvoted_new.world.gen.WorldGen;
...
public class Outvoted {
    public static final String MOD_ID = "outvoted_new";
...
//            SignSprites.addRenderMaterial(new SpriteIdentifier(TexturedRenderLayers.SIGNS_ATLAS_TEXTURE, new Identifier(outvoted_new.MOD_ID, "entity/signs/palm")));
//            SignSprites.addRenderMaterial(new SpriteIdentifier(TexturedRenderLayers.SIGNS_ATLAS_TEXTURE, new Identifier(outvoted_new.MOD_ID, "entity/signs/baobab")));
//        }
