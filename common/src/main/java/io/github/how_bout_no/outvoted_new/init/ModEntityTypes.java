...
//                    .build(new Identifier(outvoted_new.MOD_ID, "wildfire").toString()));
...
//                    .build(new Identifier(outvoted_new.MOD_ID, "glutton").toString()));
...
//                    .build(new Identifier(outvoted_new.MOD_ID, "barnacle").toString()));
